    ...
    >
      ...
      <div className="flex-1 min-h-0 overflow-y-auto px-5 py-4 max-md:py-3">
        ...
        <textarea
          ...
          rows={6}
          className="w-full px-3 py-2 max-md:h-24 rounded-field border border-line-strong bg-surface text-ink text-sm max-md:text-[16px] outline-none focus:border-accent-line resize-none leading-relaxed placeholder:text-ink-faint"
          disabled={busy}
        />
