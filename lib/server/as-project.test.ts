...
for (const name of ["idle SSE", "reconnect terminal", "P0-1 retry preserves answers", "P1-1 non-tip continuation", "P1-2 hard off fallback", "P2-2 failed startup cleans bindings", "P2-2 concurrent catchup shares initialization", "P2-3 interrupt bypasses peer lease"]) {
  test(name, async () => {
